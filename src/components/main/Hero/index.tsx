...
const Hero = () => {
  return (
    <div className=" h-1/2 md:h-screen bg-darkBlue-primary relative">
     <Image className="hidden md:block w-screen object-cover"  src={banner} alt="hero" width={2000} height={2000}/>
     ...
     <div className="bg-darkBlue-primary flex flex-col items-center absolute max-w-xl mx-auto py-10 top-0 right-0 left-0 z-10">
        ...
        <button className="text-white text-xs md:text-sm bg-green-primary my-2 py-2 px-8 rounded-full">
        START A SPORTS BLOG
        </button>
