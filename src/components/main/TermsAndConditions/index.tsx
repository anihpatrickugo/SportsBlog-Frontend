    ...
    return (
      <section className="w-full p-4">
        <div className="max-w-4xl mx-auto flex flex-col justify-between items-start">
          <h1 className="text-3xl self-center font-bold text-grey-stronger my-4"> Terms & Conditions </h1>

          <div className="flex flex-col justify-between my-4">
            <h3 className="font-bold text-xl text-grey-strong">Our Terms and Conditions</h3>
            <p className="text-grey-strong md:text-2xl my-1">
            Welcome to Mysportsblog.com
           </p>
            <p className="text-grey-strong md:text-2xl my-1">
            These terms and conditions outline the rules and regulations for the use of Mysportsblog&apos;s Website, 
            located at https://mysportsblog.com.
           </p>
            <p className="text-grey-strong md:text-2xl my-1">
            By accessing this website we assume you accept these terms and conditions. 
            Do not continue to use Mysportsblog.com if you do not agree to take all of the terms and conditions stated on this page.
           </p>
            <p className="text-grey-strong md:text-2xl my-1">
            ...
            refers to both the Client and ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to 
            undertake the process of our assistance to the Client in the most appropriate manner for the express purpose of meeting the 
            Client&apos;s needs in respect of provision of the Company&apos;s stated services, in accordance with and subject to, prevailing law of us. 
          ...
          <div className="flex flex-col justify-between my-4">
            ...
            <p className="text-grey-strong md:text-2xl my-1">
            We employ the use of cookies. By accessing Mysportsblog.com, 
            you agreed to use cookies in agreement with the Mysportsblog&apos;s Privacy Policy.
            </p>
          ...
          <div className="flex flex-col justify-between my-4">
            <h3 className="font-bold text-xl text-grey-strong">License</h3>
            <p className="text-grey-strong md:text-2xl my-1">
            Unless otherwise stated, Mysportsblog and/or its licensors own the intellectual property rights for all material on Mysportsblog.com. 
            All intellectual property rights are reserved. You may access this from Mysportsblog.com for your own personal use subjected to 
            ...
            <ul className="text-grey-strong px-16 list-disc md:text-lg" >
                <li>Republish material from Mysportsblog.com</li>
                <li>Sell, rent or sub-license material from Mysportsblog.com</li>
                <li>Reproduce, duplicate or copy material from Mysportsblog.com</li>
                <li>Redistribute content from Mysportsblog.com</li>
            </ul>
            ...
            Mysportsblog does not filter, edit, publish or review Comments prior to their presence on the website. 
            Comments do not reflect the views and opinions of Mysportsblog,its agents and/or affiliates. 
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, 
            Mysportsblog shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any
             use of and/or posting of and/or appearance of the Comments on this website.
            </p>
            
            <p className="text-grey-strong md:text-2xl my-1">
            Mysportsblog reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, 
           ...
           You warrant and represent that:
            ...
            <p className="text-grey-strong md:text-2xl my-1">
            You hereby grant Mysportsblog a non-exclusive license to use, reproduce, edit and authorize others to use, 
          ...
          <div className="flex flex-col justify-between my-4">
            <h3 className="font-bold text-xl text-grey-strong">Hyperlinking to our Content</h3>
            <p className="text-grey-strong md:text-2xl my-1">
            ...
            (c) the benefit to us from the visibility of the hyperlink compensates the absence of Mysportsblog; and 
           ...
           (c) fits within the context of the linking party&apos;s site.
            ...
            you must inform us by sending an e-mail to Mysportsblog. Please include your name, your organization name, 
            ...
            <p className="text-grey-strong md:text-2xl my-1">
            No use of Mysportsblog&apos;s logo or other artwork will be allowed for linking absent a trademark license agreement.
            </p>
          </div>

          <div className="flex flex-col justify-between my-4">
            <h3 className="font-bold text-xl text-grey-strong">iFrames</h3>
            <p className="text-grey-strong md:text-2xl my-1">
          ...
          <div className="flex flex-col justify-between my-4">
            <h3 className="font-bold text-xl text-grey-strong">Content Liability</h3>
            <p className="text-grey-strong md:text-2xl my-1">
          ...
          <div className="flex flex-col justify-between my-4">
            <h3 className="font-bold text-xl text-grey-strong">Reservation of Rights</h3>
            <p className="text-grey-strong md:text-2xl my-1">
            We reserve the right to request that you remove all links or any particular link to our Website. 
            You approve to immediately remove all links to our Website upon request. We also reserve the right to amen these terms and 
            conditions and it&apos;s linking policy at any time. By continuously linking to our Website, 
            you agree to be bound to and follow these linking terms and conditions.
            </p>
          </div>

          <div className="flex flex-col justify-between my-4">
            <h3 className="font-bold text-xl text-grey-strong">Removal of links from our website</h3>
          ...
          <div className="flex flex-col justify-between my-4">
            <h3 className="font-bold text-xl text-grey-strong">Disclaimer</h3>
            <p className="text-grey-strong md:text-2xl my-1">
