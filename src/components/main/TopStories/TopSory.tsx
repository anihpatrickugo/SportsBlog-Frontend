  ...
  return (
    <div className="w-full md:w-5/12 mb-8 flex justify-start items-start gap-1 hover:md:w-6/12">
                 ...
                 <div className="flex-1 flex flex-col justify-evenly">
                    <Link href="/" className='font-bold text-xs md:text-sm hover:text-green-primary'>{title}</Link>
                     <Link href="/" className=' text-[12px] md:text-xs font-bold mt-6 hover:text-green-primary'>{author} <span className='font-normal text-grey-strong'>{date}</span></Link>
