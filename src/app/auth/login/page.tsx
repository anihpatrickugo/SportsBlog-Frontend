  ...
  return (
    <section className="w-screen bg-grey-ultraLight p-4 absolute top-0 left-0 right-0 bottom-0">
      <div className="max-w-3xl mx-auto flex flex-col justify-between items-center bg-white p-4">
        ...
        <button className="w-8/12 md:w-6/12 bg-grey-light hover:bg-grey-strong active:bg-red-400 py-4 text-sm text-grey-stronger rounded-full flex item-center justify-center"> <i className="mx-4"> <FcGoogle size={25}/> </i> Continue with Google</button>
